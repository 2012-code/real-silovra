    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6 py-24">
            <div className="max-w-4xl w-full space-y-16">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full py-4 bg-zenith-indigo text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-zenith-indigo/80 transition-all flex items-center justify-center gap-3 disabled:opacity-50 shadow-lg shadow-zenith-indigo/20"
                        >
                            {loading ? (
                ...
                >
                    Cancel anytime · Secure payments via Stripe · No long-term contracts
                </motion.p>
            </div>
        </div>
    )
